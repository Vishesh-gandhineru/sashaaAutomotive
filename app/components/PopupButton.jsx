...
export default function PopupButton({buttonText = "Enquire Now"}) {
    return (
        <Dialog>
            <DialogTrigger asChild>
                <div className="flex justify-center items-center hover:scale-[1.1] transition-all ease-in-out">
            ...
            <DialogContent className="max-w-[90%] max-h-[80%] sm:max-h-fit overflow-y-scroll sm:overflow-hidden sm:max-w-[95%] md:max-w-[90%] lg:max-w-[70%] translate-x-[-50%] m-auto border-none bg-[#1B1B1B] p-0">
                <div className="flex flex-col sm:flex-row">
                    <div className="w-full sm:w-[80%] mx-auto p-10 py-[50px]">
