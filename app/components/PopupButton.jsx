...
export default function PopupButton({buttonText = "Enquire Now" , className ,}) {
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-[90%] max-h-[80%] sm:max-h-fit overflow-y-scroll sm:overflow-hidden sm:max-w-[95%] md:max-w-[90%] lg:max-w-[70%] translate-x-[-50%] m-auto border-none bg-[#1B1B1B] p-[0px]">
            <DialogClose asChild>
                <CloseCircleIcon className="w-[35px] h-[35px] absolute left-[95%] top-[3%] z-50 cursor-pointer hover:scale-[1.1] transition-all transition-[]"/>
            </DialogClose>
