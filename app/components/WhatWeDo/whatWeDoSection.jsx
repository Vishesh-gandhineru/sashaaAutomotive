...
export default async function WhatWeDoSection () {
    ...
    return (
        <section className="max-w-[1300px] p-5 m-auto lg:mt-[50px]">
            ...
            <p className="text-[16px] leading-[24px] lg:w-[60%] lg:text-center lg:m-auto lg:mb-[30px]">Welcome to the one-stop shop for premium European auto components. We specialise in a myriad of OEM-manufactured spare parts, available for both wholesale and retail.<br/> <br/>
